...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://ssrgbsco_san123:SKDrns!008@localhost/ssrgbsco_wp?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://ssrgbsco_san123:SKDrns!008@localhost/ssrgbsco_wp?new_link=true');
  }
}
...
$civicrm_root = '/home/ssrgbsco/public_html/sankirtan/wordpress/wp-content/plugins/civicrm/civicrm/';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/home/ssrgbsco/public_html/sankirtan/wordpress/wp-content/uploads/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://ssrgbs.com/sankirtan/wordpress/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'e75772d2a6c6280665581156791d4526');
}
...
// define( 'CIVICRM_MAIL_LOG', '/home/ssrgbsco/public_html/sankirtan/wordpress/wp-content/uploads/civicrm/templates_c//mail.log');
// }
